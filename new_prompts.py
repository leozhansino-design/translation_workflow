# 新的Prompt模板 - 待审核后替换到prompt_manager.py

NEW_OUTLINE_PROMPT = """# ADDICTIVE WEB NOVEL OUTLINE GENERATOR
...
NEW_WRITER_PROMPT = """# ADDICTIVE WEB NOVEL WRITER
...
if __name__ == "__main__":
    print("新Prompt模板已创建")
    print(f"Outline Prompt: {len(NEW_OUTLINE_PROMPT)} 字符")
    print(f"Writer Prompt: {len(NEW_WRITER_PROMPT)} 字符")
